...
export function JsonPage() {
  ...
  const copyTemplate = async () => {
    ...
    const always = ['id', 'name', 'active', 'media', 'visibility', 'extensions', 'identity', 'placement', 'statBlocks', 'components', 'type', 'state', 'category', 'rarity', 'sheet', 'movements', 'attacks', 'abilities', 'skills', 'traits'];
